    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              ...
              From electricians to plumbers, we connect you with verified professionals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/search" className="hover:text-white transition-colors">Find Services</Link>
              </li>
              <li>
                <Link to="/register?role=provider" className="hover:text-white transition-colors">Become a Provider</Link>
              </li>
              <li>
                <Link to="/#how-it-works" className="hover:text-white transition-colors">How it Works</Link>
              </li>
              <li>
                <Link to="/search" className="hover:text-white transition-colors">Pricing</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span>support@localify.com</span>
              </li>
              <li className="flex items-center space-x-2">
              ...
              <li className="flex items-start space-x-2">
                ...
                <span>123 Service Street<br />Mumbai, MH 400101</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Localify. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
